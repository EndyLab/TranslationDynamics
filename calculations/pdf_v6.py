...
def pdfgen(voxlength, dr, numdens, histogram,numexp):
	pdfvalgr = []
	binsval = int(voxlength/dr)
...
# for jj in xrange(1):
	...
	numdens = (420)/((max_dist[jj]*2)**3) #Number density across runs; density is over voxel volume not sphere vol
	print(numdens)
	pdfval[gr[jj]] = pdfgen( vox[jj], dr, numdens, histgr[gr[jj]],expnum)
