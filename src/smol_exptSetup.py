...
for i in range(i_max):
	...
	for k in range (0, k_max):
		...
		for j in range(0, j_max):
			...
			expt.write("variable _side_len_ " + str(_side_len_) + "\n")
			expt.write("variable _tRNA_cog_NUM_ " + str(_tRNA_cog_NUM_)+ "\n")
			expt.write("variable _tRNA_nr_NUM_ " + str(_tRNA_nr_NUM_)+ "\n")
			expt.write("variable _tRNA_non_NUM_ " + str(_tRNA_non_NUM_)+ "\n")
			expt.write("variable _crowder_NUM_ " + str(_crowder_NUM_)+ "\n")
			expt.write("variable _ribosome_NUM_ " + str(_ribosome_NUM_)+ "\n")
			expt.write("variable _ribosome_cog_NUM_ " + str(_ribosome_cog_NUM_)+ "\n")
			expt.write("variable _ribosome_nr_NUM_ " + str(_ribosome_nr_NUM_)+ "\n")
			expt.write("variable _ribosome_non_NUM_ " + str(_ribosome_non_NUM_)+ "\n")
			expt.write("variable _ribosome_suc_NUM_ " + str(_ribosome_suc_NUM_)+ "\n")
			expt.write("variable _ribosome_inac_NUM_ " + str(_ribosome_inac_NUM_)+ "\n")
			expt.write("variable _ribosome_noreac_NUM_ " + str(_ribosome_noreac_NUM_)+ "\n")
			expt.write("variable _tRNA_uni_NUM_ " + str(_tRNA_uni_NUM_)+ "\n")

			expt.write("variable _D_tRNAEfTu_ " + str(_D_tRNAEfTu_) + "\n")
			expt.write("variable _D_ribosome_ " + str(_D_ribosome_) + "\n")
			expt.write("variable _D_crowder_ " + str(_D_crowder_) + "\n")
			...
			expt.write("define_global _outputReactions_ " + "data/"+_outputReactions_+"\n")
			expt.write("define_global _outputMolPos_ " + "data/"+_outputMoleculePos_+"\n")
			expt.write("define_global _seed_ " + str(_seed_) + "\n")
