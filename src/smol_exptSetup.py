...
ribosomes = list([9-1,9-1,9-1,9-1,9-1,9-1]) #ribosomes = [4,8,9,9,8,7]
side_len = list([0.0774*1/0.0059,0.0774*1/0.0059,0.0774*1/0.0059,0.0774*1/0.0059,0.0774*1/0.0059,0.0774*1/0.0059]) #sidelen = [0.101,0.0929,0.0842,0.0774,0.072,0.0677]
