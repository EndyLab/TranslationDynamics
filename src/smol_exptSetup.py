...
def setup():
	...
	exptList = open("spaceballs/expt_list.txt","w")
	outputSimtimeList=open("spaceballs/outputSimtimeList.txt","w")
	outputMolposList=open("spaceballs/outputMolposList.txt","w")
	expt_description = open("spaceballs/expt_description.txt","w")
	...
	for i in range(0,2):
		...
		for j in range(0, j_max):
			...
			expt = open("spaceballs/" + exptname,'w')
